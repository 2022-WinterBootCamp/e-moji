...
export default function FirstPage() {
    ...
    return (
        ...
        >
          ...
          <Computer>
                    <Typography variant="h2" align="left" color="text.secondary" style={{marginTop: 350, marginLeft: 100}} paragraph>
                        이모지 변환 플랫폼, IGE MOJI
                    </Typography>
                    <Typography
                        component="h1"
                    ...
                    <Stack
                        ...
                        justifyContent="left"
                    >
                        <Button href="/mainpage" variant="contained" style={{backgroundColor: 'black', borderRadius: 50, fontSize: 35, fontWeight: 'bold'}}>이모지 보러 가기</Button>
                        <Button onClick={() => {handleOpen();}} variant="outlined" style={{color: 'black',borderRadius: 50, fontSize: 35, borderColor: 'black'}}>사용법 보러 가기</Button>
                    </Stack>
                    <Lottie
